...
public class QueryConstants {
	...
	public static final String LIST_INVOICE_BY_MONTH = "select invoiceid,taxinvoiceid,to_char(invoicedate,'DD/MM/YYYY')\"invoicedate\",invoicetype,invoicecustomerid,invoice.remarks as remarks,name as invoicecustomername from invoice inner join customer on invoice.invoicecustomerid=customer.customerid where invoice.activeflag=? and  customer.priveleged=0 and invoice.invoicedate like ? order by invoicedate,invoiceid";
	public static final String LIST_INVOICE_INCL_PRIV_BY_MONTH = "select invoiceid,taxinvoiceid,to_char(invoicedate,'DD/MM/YYYY')\"invoicedate\",invoicetype,invoicecustomerid,invoice.remarks as remarks,name as invoicecustomername from invoice inner join customer on invoice.invoicecustomerid=customer.customerid where invoice.activeflag=? and invoice.invoicedate like ? order by invoicedate,invoiceid";
	...
	public static final String LIST_TAX_INVOICE_BY_MONTH = "select taxinvoiceid,to_char(taxinvoicedate,'DD/MM/YYYY')\"taxinvoicedate\",taxinvoicetype,taxinvoicecustomerid,taxinvoice.remarks as remarks,name as taxinvoicecustomername from taxinvoice inner join customer on taxinvoice.taxinvoicecustomerid=customer.customerid where taxinvoice.activeflag=? and  customer.priveleged=0 and taxinvoice.taxinvoicedate like ? order by taxinvoicedate,taxinvoiceid";
	public static final String LIST_TAX_INVOICE_INCL_PRIV_BY_MONTH = "select taxinvoiceid,to_char(taxinvoicedate,'DD/MM/YYYY')\"taxinvoicedate\",taxinvoicetype,taxinvoicecustomerid,taxinvoice.remarks as remarks,name as taxinvoicecustomername from taxinvoice inner join customer on taxinvoice.taxinvoicecustomerid=customer.customerid where taxinvoice.activeflag=? and taxinvoice.taxinvoicedate like ? order by taxinvoicedate,taxinvoiceid";
	public static final String GET_TAX_INVOICE_BY_ID = "select taxinvoiceid,to_char(taxinvoicedate,'DD/MM/YYYY')\"taxinvoicedate\",taxinvoicetype,taxinvoicecustomerid,taxinvoice.remarks as remarks,name as taxinvoicecustomername,customeraddress as consignorAddress,customerstate as consignorStateCode,gst_state.statename as consignorState,taxuniqueid as consignorTaxUniqueId from taxinvoice inner join customer on taxinvoice.taxinvoicecustomerid=customer.customerid left join gst_state on customer.customerstate=gst_state.statecode where taxinvoice.activeflag=? and taxinvoiceid=?";
