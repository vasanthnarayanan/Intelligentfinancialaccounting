...
function createslide(start)
	{
		...
		{
		$('<li><a href="/listCustomers?pageno='+(i+1)+'&sorttype='+sortType+'">'+(i+1)+'</a></li>').appendTo('.pages');
		}
	}
...
$('#pagination-ifas .previous').live("click",function(event){
	...
	window.location="/listCustomers?pageno="+(pageNo-1)+"&sorttype="+sortType+"";
});
...
$('#pagination-ifas .first').live("click",function(event){
	createslide(0);
	setSelectedItem(0);
	window.location="/listCustomers?pageno=1&sorttype="+sortType+"";
});
...
$('#pagination-ifas .last').live("click",function(event){
	...
	window.location="/listCustomers?pageno="+noofpagelinks+"&sorttype="+sortType+"";
});
...
$("#go").live("click",function(){
	...
	window.location="/listCustomers?pageno="+$gotoval+"&sorttype="+sortType+"";
});

function pagination(totalrows,recperpage,pNo,sType){
	window.pageNo=pNo;
	window.sortType=sType;
