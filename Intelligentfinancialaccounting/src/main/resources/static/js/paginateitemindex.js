...
function createslide(start)
	{
		...
		{
		$('<li><a href="/listItems?pageno='+(i+1)+'&sorttype='+sortType+'">'+(i+1)+'</a></li>').appendTo('.pages');
		}
	}
...
$('#pagination-ifas .previous').live("click",function(event){
	...
	window.location="/listItems?pageno="+(pageNo-1)+"&sorttype="+sortType+"";
});
...
$('#pagination-ifas .first').live("click",function(event){
	createslide(0);
	setSelectedItem(0);
	window.location="/listItems?pageno=1&sorttype="+sortType+"";
});
...
$('#pagination-ifas .last').live("click",function(event){
	...
	window.location="/listItems?pageno="+noofpagelinks+"&sorttype="+sortType+"";
});
...
$("#go").live("click",function(){
	...
	window.location="/listItems?pageno="+$gotoval+"&sorttype="+sortType+"";
});
